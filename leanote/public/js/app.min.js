...
function formSerializeDataToJson(t) {
    for (var e = t.split("&"), n = {}, o = {}, r = 0; r < e.length; ++r) {
        var i = e[r].split("="), a = decodeURI(i[0]), s = decodeURI(i[1]);
...
function _ajax(t, e, n, o, r, i) {
    return i = "undefined" == typeof i ? !0 : !1, $.ajax({
        type: t, url: e, data: n, async: i, success: function (t) {
            _ajaxCallback(t, o, r)
        }, error: function (t) {
            _ajaxCallback(t, o, r)
        }
...
function setEditorContent(t, e, n, o) {
    ...
    }, 100); else if ("undefined" != typeof tinymce && tinymce.activeEditor) {
...
function _getEditorContent(t) {
    ...
    if (e) {
        ...
        if (n.find(".toggle-raw").remove(), window.LeaAce && LeaAce.getAce) for (var o = n.find("pre"), r = 0; r < o.length; ++r) {
            var i = o.eq(r), a = i.attr("id"), s = LeaAce.getAce(a);
            if (s) {
                var l = s.getValue();
...
function notifyError(t) {
    $.pnotify.defaults.delay = 2e3, $.pnotify({title: "通知", text: t, type: "error", styling: "bootstrap"})
}
...
function initCopy(t, e) {
    var n = new ZeroClipboard(document.getElementById(t), {moviePath: "/js/ZeroClipboard/ZeroClipboard.swf"});
...
function setCookie(t, e, n) {
    var o = new Date;
    o.setDate(o.getDate() + n), document.cookie = t + "=" + escape(e) + (null == n ? "" : ";expires=" + o.toGMTString()) + "path=/", document.cookie = t + "=" + escape(e) + (null == n ? "" : ";expires=" + o.toGMTString()) + "path=/note"
}

function logout() {
    Note.curChangedSaveIt(!0), LEA.isLogout = !0, setCookie("LEANOTE_SESSION", "", -1), location.href = UrlPrefix + "/logout?id=1"
}
...
function saveBookmark() {
    try {
        if (LEA.bookmark = tinymce.activeEditor.selection.getBookmark(), LEA.bookmark && LEA.bookmark.id) {
            var t = $($("#editorContent_ifr").contents()), e = t.find("body"), n = e.children().eq(0);
            if (n.is("span")) {
                var o = n, r = o.eq(0);
...
var Notebook = {cache: {}}, Note = {cache: {}}, Tag = {}, Notebook = {}, Share = {}, Mobile = {}, LeaAce = {},
    Converter, MarkdownEditor, ScrollLink, MD;
$.extend(LEA, {
    _eventCallbacks: {}, _listen: function (t, e) {
...
var previewToken = "<div style='display: none'>FORTOKEN</div>", clearIntervalForSetContent;
...
var vd = {
    isInt: function (t) {
        ...
        function is_required(t) {
            var e = get_name(t), n = get_rules(t, e), o = n[0];
        ...
        function apply_rules(t, e) {
            ...
            for (var o = 0; o < n.length; ++o) {
                var r = n[o], i = r.rule, a = r.msg, s = r.msgData;
        ...
        var get_val = function (t) {
            if (t.is(":checkbox")) {
                var e = t.attr("name"), n = $('input[name="' + e + '"]:checked').length;
                return n
            }
        ...
        var rules = {}, msg_targets = {}, $allElems = $(form).find("[data-rules]"), $form = $(form);
        $form.on({
            keyup: function (t) {
...
Note.curNoteId = "", Note.interval = "", Note.itemIsBlog = '<div class="item-blog"><i class="fa fa-bold" title="blog"></i></div><div class="item-setting"><i class="fa fa-cog" title="setting"></i></div>', Note.itemTplNoImg = '<li href="#" class="item ?" data-seq="?" noteId="?">', Note.itemTplNoImg += Note.itemIsBlog + '<div class="item-desc"><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>', Note.itemTpl = '<li href="#" class="item ? item-image" data-seq="?" noteId="?"><div class="item-thumb" style=""><img src="?"/></div>', Note.itemTpl += Note.itemIsBlog + '<div class="item-desc" style=""><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>', Note.newItemTpl = '<li href="#" class="item item-active ?" data-seq="?" fromUserId="?" noteId="?">', Note.newItemTpl += Note.itemIsBlog + '<div class="item-desc" style="right: 0px;"><p class="item-title">?</p><p class="item-info"><i class="fa fa-book"></i> <span class="note-notebook">?</span> <i class="fa fa-clock-o"></i> <span class="updated-time">?</span></p><p class="desc">?</p></div></li>', Note.noteItemListO = $("#noteItemList"), Note.cacheByNotebookId = {all: {}}, Note.notebookIds = {}, Note.isReadOnly = !1, Note.intervalTime = 0, Note.intervalTime = 1e4, Note.startInterval = function () {
    ...
    var e = Note.getSorterAndOrder(), o = e.sortBy, a = e.isAsc;
    ...
    if (!o) return !1;
    var a = $("#noteTitle").val(), n = Tag.getTags(), i = {
        hasChanged: !1,
        IsNew: o.IsNew,
    ...
    if (Note.curNoteId && !Note.isReadOnly) {
        ...
        return n && n.hasChanged ? (log("需要保存..."), Note.renderChangedNote(n), delete n.hasChanged, showMsg(getMsg("saving")), a.saveInProcess[n.NoteId] = !0, ajaxPost("/note/updateNoteOrContent", n, function (t) {
            a.saveInProcess[n.NoteId] = !1, n.IsNew && (t.IsNew = !1, Note.setNoteCache(t, !1), Pjax.changeNote(t)), e && e(), showMsg(getMsg("saveSuccess"), 1e3)
    ...
    for (var e in t.savePool) if (e) {
        delete t.savePool[e];
        var o = t.savePool[e];
        t.saveInProcess[e] = !0, ajaxPost("/note/updateNoteOrContent", o, function (o) {
            t.saveInProcess[e] = !1
        })
    }
    ...
    var e = $("#noteItemList"), o = e.height(), a = $("[noteId='" + t + "']").position();
    if (!a) return void console.error("no position: " + t);
    var n = a.top, i = e.scrollTop();
    if (n += i, n >= i && o + i >= n) ; else {
        var r = n;
    ...
    if (t) {
        ...
        if (s) {
            ...
            var d = "/note/getNoteContent", N = {noteId: t};
...
Note.checkSorter = function (t) {
    ...
    var t = "UpdatedTime", e = !1, o = localStorage.getItem("sorterType");
    ...
    var i = t.length, r = Math.ceil(i / 20);
    ...
    var i = "", r = "item-my";
    e && (r = "item-shared");
    var s = Notebook.getNotebook(t), c = s ? s.Title : "", l = getCurDate();
    ...
    showDialog("dialogShareNote", {title: getMsg("shareToFriends") + "-" + e}), setTimeout(function () {
        $("#friendsEmail").focus()
    }, 500);
    var o = $(t).attr("noteId");
    ...
    var e = new Date, o = e.getTime() - Note.lastSearchTime.getTime();
    ...
    return t ? void (Note.isSameSearch(t) || (Note.lastSearch && Note.lastSearch.abort(), Note.curChangedSaveIt(), Note.clearAll(), showLoading(), Notebook.showNoteAndEditorLoading(), Note.listIsIn(!1, !0), $("#tagSearch").hide(), Note.lastSearch = $.post("/note/searchNote", {key: t}, function (t) {
    ...
    o = Note.inBatch ? a.getBatchNoteIds() : [$(t).attr("noteId")], ajaxPost("/note/setNote2Blog", {
        ...
        if (t) for (var n = 0; n < o.length; ++n) {
            var i = o[n], r = a.getTargetById(i);
            e ? r.addClass("item-b") : r.removeClass("item-b"), a.setNoteCache({NoteId: i, IsBlog: e}, !1)
        }
    })
    ...
    if (t) {
        ...
        if (isArray(o)) {
            var a = o.length;
            if (0 == a) for (var n in Note.cache) Note.cache[n].NotebookId == t && (Note.cache[n].IsBlog = e); else for (var n = 0; a > n; ++n) o[n].IsBlog = e
        }
    }
    ...
    if (0 != r.length) {
        var d = "/note/copyNote", e = {noteIds: r, notebookId: i};
        if (o) {
    ...
    var e = this, o = e.getCurNote(), a = $("#editor");
    ...
    if (LEA.readOnly) {
        // alter by yzx
        $('#leftNotebook').css("display", "none");
        $('#leftNotebook').css("width", "0px");
        $("#noteList").css('width', '0px')
        $('#noteList').css("display", "none");
        $("#note").css('left','0px');
        $("#noteAndEditor").css('left', '0px');
        Note.toggleWriteable()
    } else {
        $('#leftNotebook').css("display", "inline-block");
        $('#leftNotebook').css("width", "160px");
        $('#noteList').css("display", "inline-block");
        $("#noteList").css('width', '266px');
        $("#noteAndEditor").css('left', '160px');
        $('#note').css('left','266px');
        Note.toggleReadOnly(!0);
    ...
    var e = [], o = [], a = [];
    for (var n in t) {
        var i = t[n], r = {text: i.Title, notebookId: i.NotebookId, action: Note.moveNote},
            s = {text: i.Title, notebookId: i.NotebookId, action: Note.copyNote},
            c = {text: i.Title, notebookId: i.NotebookId, action: Share.copySharedNote};
        if (!isEmpty(i.Subs)) {
    ...
    function t(t) {
        var e = $(this).attr("noteId"), o = [];
        if (Note.inBatch) o.push("shareToFriends"), o.push("exportPDF"), Notebook.curActiveNotebookIsTrash() && (o.push("shareStatus"), o.push("unset2Blog"), o.push("set2Blog"), o.push("copy")); else {
            var a = Note.getNote(e);
            if (!a) return;
            if (a.IsTrash || Notebook.curActiveNotebookIsTrash()) o.push("shareToFriends"), o.push("shareStatus"), o.push("unset2Blog"), o.push("set2Blog"), o.push("copy"); else {
    ...
    var a = Notebook.everNotebooks, n = o.getContextNotebooks(a), i = n[0], r = n[1];
    o.notebooksCopy = n[2];
    var s = {
        width: 180,
        items: [{
            ...
            width: 180,
            items: i
        }, {text: getMsg("copy"), alias: "copy", icon: "", faIcon: "fa-copy", type: "group", width: 180, items: r}],
        onShow: t,
        onContextMenu: e,
        parent: "#noteItemList",
        children: ".item-my"
...
var Attach = {
    ...
    init: function () {
        ...
        $("#showAttach").click(function () {
            ...
            e.stopPropagation();
            var o = $(this).closest("li").data("id"), a = this;
            confirm(getMsg("Are you sure to delete it ?")) && ($(a).button("loading"), ajaxPost("/attach/deleteAttach", {attachId: o}, function (e) {
            ...
            e.stopPropagation();
            var o = $(this).closest("li").data("id"), a = t.attachsMap[o],
    ...
    renderAttachs: function (t) {
        var e = this;
        return e.loadedNoteAttachs[t] ? void e._renderAttachs(e.loadedNoteAttachs[t]) : (e.attachListO.html('<li class="loading"><img src="/images/loading-24.gif"/></li>'), void ajaxGet("/attach/getAttachs", {noteId: t}, function (o) {
            var a = [];
...
Note.inBatch = !1, Note.getBatchNoteIds = function () {
    ...
    isInBatch: function () {
        var t = this, e = t.$noteItemList.find(".item-active");
    ...
    selectTo: function (t) {
        ...
        e || alert("nono start");
        var o, a, n, i, r = +e.data("seq"), s = +t.data("seq");
    ...
    finalFix: function (t) {
        var e = this;
        if (e.isInBatch()) Note.clearCurNoteId(), e.renderBatchNotes(), e.setInBatch(); else {
    ...
    renderBatchNotes: function () {
        ...
        for (var n in t._notes) if (!o[n]) {
            var i = t._notes[n];
            i.css({"margin-left": "-800px"}), setTimeout(function () {
                i.remove()
    ...
    _i: 1,
    getRotate: function () {
        var t = this, e = t._i++, o = e % 2 === 0 ? 1 : -1, a = (o * Math.random() * 70, [0, 10, 20, 30, 40]),
            n = o * a[e % 5] * 3;
    ...
    addTo: function (t) {
        var e = this;
        if (!e._notes[t]) {
            var o = Note.getNote(t), a = o.Title || getMsg("unTitled"), n = o.Desc || "...",
                i = $('<div class="batch-note"><div class="title">' + a + '</div><div class="content">' + n + "</div></div>");
            e._notes[t] = i;
            var r = e.getRotate();
            e.$batchCtn.append(i), setTimeout(function () {
                i.css({transform: "rotate(" + r[0] + "deg)", "margin-left": r[1] + "px"})
            })
        }
    }
}, $(function () {
    Attach.init(), $("#noteItemList").on("mouseenter", ".item", function (t) {
        ...
        var e = $(this).parent().attr("noteId"), o = Note.getNote(e);
...
function initSlimScroll() {
    Mobile.isMobile() || ($("#notebook").slimScroll({height: "100%"}), $("#noteItemList").slimScroll({height: "100%"}), $("#wmd-panel-preview").slimScroll({height: "100%"}), $("#wmd-panel-preview").css("width", "100%"))
}
...
function initEditor() {
    $("#moreBtn").click(function () {
        ...
        if (o) {
            if (83 == t) return Note.curChangedSaveIt(!0, null, {ctrls: !0}), e.preventDefault(), !1;
...
function scrollTo(e, t, o) {
    var i = $("#editorContent"), n = i.find(t + ":contains(" + o + ")");
    random++;
...
function getMaxDropdownHeight(e) {
    var t = $(e).offset(), o = $(document).height() - t.top;
    o -= 70, 0 > o && (o = 0);
...
function getNoteBySrc(e, t) {
    ajaxGet("/note/getNoteAndContentBySrc", {src: e}, function (e) {
        if (e && e.Ok) {
            var o = e.Item;
            if (o) {
                var i = o.NoteInfo, n = o.NoteContentInfo;
...
function _initPage(e, t) {
    if (e ? (curNoteId = e.NoteId, curNotebookId = e.NotebookId, noteContentJson = e) : t && (curNoteId = null), Notebook.renderNotebooks(notebooks), Share.renderShareNotebooks(sharedUserInfos, shareNotebooks), curSharedNoteNotebookId) Share.firstRenderShareNote(curSharedUserId, curSharedNoteNotebookId, curNoteId); else {
    ...
    Tag.renderTagNav(tagsJson), initSlimScroll(), LeaAce.handleEvent(), t && (Mobile.toEditor(), e || (Note.newNote(), Note.toggleWriteable(!0), setTimeout(function () {
...
editorMode.prototype.toggleAText = function (e) {
    var t = this;
    setTimeout(function () {
        var o = $(".toggle-editor-mode a"), i = $(".toggle-editor-mode span");
    ...
    $(".toggle-editor-mode").click(function (t) {
        ...
        var o = $(this).find("a"), i = e.isWriting(o.attr("href"));
    ...
    e += ".css";
    $("#themeLink");
    -1 != this.$themeLink.attr("href").indexOf("writting-overwrite.css") && this.$themeLink.attr("href", LEA.sPath + "/css/theme/" + e), $("#noteList").width(UserInfo.NoteListWidth), $("#note").css("left", UserInfo.NoteListWidth), this.isWritingMode = !1, this.resizeEditor()
...
var Resize = {
    ...
    initEvent: function () {
        ...
        $(".layout-toggler-preview").click(function () {
            var o = $(this), i = e.leftColumn.parent();
            if (o.hasClass("open")) {
                var n = i.width(), r = 22, a = n - r;
    ...
    stopResize: function () {
        ...
        }), e.lineMove = !1, e.mdLineMove = !1, $(".noteSplit").css("background", "none"), e.mdSplitter.css("background", "none")
    },
    ...
    setMdColumnWidth: function (e) {
        var t = this, o = $("#note").width();
        e > 100 && o - 80 > e && (UserInfo.MdEditorWidth = e, t.leftColumn.width(e), t.rightColumn.css("left", e)), MD && MD.onResize()
    }
};
Mobile = {
    noteO: $("#note"), bodyO: $("body"), setMenuO: $("#setMenu"), hashChange: function () {
        var e = Mobile, t = location.hash;
...
LEA.s3 = new Date, console.log("initing..."), $(window).resize(function () {
    ...
    var t = $(this).val(), o = $("#themeLink").attr("href"), i = o.split("="), n = 1;
    2 == i.length && (n = i[1]), $("#themeLink").attr("href", LEA.sPath + "/css/theme/" + t + ".css?id=" + n), ajaxPost("/user/updateTheme", {theme: t}, function (e) {
...
var Pjax = {
    init: function () {
        ...
        if (t) {
            var o = void 0 != t.Perm, i = t.NotebookId;
        ...
        var t = e.NoteId, o = e.Title, i = "/note/" + t;
...
$(function () {
    ...
    _aceId: 0, _aceEditors: {}, _isInit: !1, _canAce: !1, isAce: !0, disableAddHistory: function () {
        ...
        if (o || i.canAndIsAce()) {
            ...
            if (0 != n.length) {
                ...
                try {
                    i.disableAddHistory();
                    var a = n.attr("class") || "", s = -1 != a.indexOf("brush:html");
    ...
    }, clearIntervalForInitAce: null, initAceFromContent: function (e) {
        if (!this.canAndIsAce()) {
            var t = $(e.getBody());
        ...
        if (this.canAndIsAce()) {
            ...
            this.clearIntervalForInitAce && clearInterval(this.clearIntervalForInitAce), this.clearIntervalForInitAce = setTimeout(function () {
                for (var o = $(e.getBody()), i = o.find("pre"), n = 0; n < i.length; ++n) {
                    ...
                    setTimeout(function (e) {
                        return function () {
                            var o = e.html(), i = e.attr("id"), n = t.getAce(i);
                            if (n) {
                                var o = n.getValue();
                                n.destroy();
                                var n = t.initAce(i, o);
        ...
        if (this.canAce()) for (var t = e.find("pre"), o = 0; o < t.length; ++o) {
            var i = t.eq(o).attr("id"), n = this.getAce(i);
        ...
        var o = this;
        if ("object" == typeof e) var i = e.attr("id"); else var i = e;
        var n = o.getAce(i);
        n && n.setReadOnly(t)
    }, nowIsInAce: function () {
        if (this.canAce()) {
        ...
        if (n) {
            ...
            i.replaceWith(s), r.destroy(), o._aceEditors[i.attr("id")] = null, t && setTimeout(function () {
                var e = tinymce.activeEditor, t = e.selection, o = t.getRng();
    ...
    }, curToggleRaw: null, handleEvent: function () {
        if (this.canAce()) {
            var e = this;
            $("#editorContent").on("mouseenter", "pre", function (t) {
                ...
                $input = o.find(".toggle-raw input"), LeaAce.isInAce(o) ? $input.prop("checked", !0) : $input.prop("checked", !1)
            }), $("#editorContent").on("mouseleave", "pre", function () {
                var e = $(this).find(".toggle-raw");
                e.remove()
            }), $("#editorContent").on("change", ".toggle-raw input", function () {
                var t = $(this).prop("checked"), o = $(this).closest("pre");
...
function reRenderTags() {
    var a = ["label label-default", "label label-info"], e = 0;
...
Tag.classes = {
...
}, Tag.mapCn2En = {"蓝色": "blue", "红色": "red", "绿色": "green", "黄色": "yellow"}, Tag.mapEn2Cn = {
    blue: "蓝色",
    red: "红色",
    green: "绿色",
    yellow: "黄色"
    ...
    function a() {
        ...
        confirm("Are you sure ?") && ajaxPost("/tag/deleteTag", {tag: a}, function (e) {
            if (reIsOk(e)) {
                var t = e.Item;
    ...
    function e() {
        var a = $(this).closest("li"), e = $.trim(a.data("tag"));
        Note.curChangedSaveIt(), Note.clearAll(), $("#tagSearch").html(a.html()).show(), $("#tagSearch .tag-delete").remove(), Note.listIsIn(!0, !1), showLoading(), ajaxGet("/note/searchNoteByTags", {tags: [e]}, function (a) {
    ...
    $("#addTagTrigger").click(function () {
        ...
        var e;
        e = $(this).attr("role") ? $(this).find("span") : $(this), Tag.appendTag({
...
Notebook.curNotebookId = "", Notebook.cache = {}, Notebook.notebooks = [], Notebook.notebookNavForListNote = "", Notebook.notebookNavForNewNote = "", Notebook.setCache = function (o) {
    ...
    function t(o, t) {
        var N = 5, a = $("#" + o + " #" + t.tId + "_switch"), n = $("#" + o + " #" + t.tId + "_ico");
    ...
    function n(o, e, t, N, a) {
        ...
        var r = t[0];
        if (N) {
            var k, i = b.tree, s = {curNotebookId: r.NotebookId};
            if (k = "inner" == a ? N : N.getParentNode()) {
                s.parentNotebookId = k.NotebookId;
                var d = k.level + 1, c = i.getNodesByFilter(n, !1, k)
            ...
            ajaxPost("/notebook/dragNotebooks", {data: JSON.stringify(s)}), setTimeout(function () {
                Notebook.changeNav()
            }, 100)
        }
    }
    ...
    if (e) var k = function (o, e, t) {
        var N = t.NotebookId, a = $(o.target).closest(".friend-notebooks").attr("fromUserId");
        Share.changeNotebook(a, N)
    }, i = null; else var k = function (o, e, t) {
        var N = t.NotebookId;
    ...
    var s = {
        view: {showLine: !1, showIcon: !1, selectedMulti: !1, dblClickExpand: !1, addDiyDom: t},
        data: {key: {name: "Title", children: "Subs"}},
        edit: {enable: !0, showRemoveBtn: !1, showRenameBtn: !1, drag: {isMove: r, prev: r, inner: r, next: r}},
        callback: {
            beforeDrag: N,
            beforeDrop: a,
            onDrop: n,
            ...
            beforeRename: function (o, e, t, N) {
                ...
                if (e.IsNew) {
                    var a = e.getParentNode(), n = a ? a.NotebookId : "";
    ...
    var e = this, t = $("#notebookListForSearch"), N = $("#notebookList");
    if (o) {
        t.show(), N.hide();
        var a = e.tree.getNodesByParamFuzzy("Title", o);
        if (log("search"), log(a), isEmpty(a)) t.html(""); else {
    ...
    var o = Notebook, e = Notebook.tree.getNodes(), t = e.slice(1, -1), N = o.getChangedNotebooks(t);
    ...
    if (!isEmpty(o) && e && "object" == typeof e && !(e.length < 0)) {
        var t = $("#shareNotebooks"), N = {};
        for (var a in e) {
            var n = e[a];
            N[n.UserId] = n
        }
        for (var a in o) {
            var r = o[a], n = N[r.UserId] || {ShareNotebooks: []};
            n.ShareNotebooks = [{NotebookId: "-2", Title: "默认共享"}].concat(n.ShareNotebooks);
    ...
    var N = "/note/listNotes/", a = {notebookId: o};
    if (Notebook.isTrashNotebookId(o)) N = "/note/listTrashNotes", a = {}; else if (Notebook.isAllNotebookId(o)) {
        ...
        var n = Notebook.cache[o], r = cacheNotes ? cacheNotes.length : 0;
    ...
    if (!Notebook.isTrashNotebookId(o) && !Notebook.isAllNotebookId(o)) {
        ...
        var e = "/note/listNotes/", t = {notebookId: o};
    ...
    var e = $(o).text();
    showDialog("dialogShareNote", {title: "分享笔记本给好友-" + e}), setTimeout(function () {
        $("#friendsEmail").focus()
    }, 500);
    var t = $(o).attr("notebookId");
    shareNoteOrNotebook(t, !1)
}, Notebook.setNotebook2Blog = function (o) {
    var e = $(o).attr("notebookId"), t = Notebook.cache[e], N = !0;
    void 0 != t.IsBlog && (N = !t.IsBlog), Notebook.curNotebookId == e ? N ? $(".item").addClass("item-b") : $(".item").removeClass("item-b") : Notebook.curNotebookId == Notebook.allNotebookId && $("#noteItemList .item").each(function () {
        var o = $(this).attr("noteId"), t = Note.cache[o];
        t.NotebookId == e && (N ? $(this).addClass("item-b") : $(this).removeClass("item-b"))
    }), ajaxPost("/notebook/setNotebook2Blog", {notebookId: e, isBlog: N}, function (o) {
        o && (Note.setAllNoteBlogStatus(e, N), Notebook.setCache({NotebookId: e, IsBlog: N}))
    })
}, Notebook.updateNotebookTitle = function (o) {
    var e = Notebook, t = $(o).attr("notebookId");
    ...
    var t = Notebook;
    ajaxPost("/notebook/updateNotebookTitle", {notebookId: o, title: e}, function (N) {
    ...
    var N = Notebook;
    ajaxPost("/notebook/addNotebook", {notebookId: o, title: e, parentNotebookId: t}, function (e) {
        if (e.NotebookId) {
    ...
    var t = $(o).attr("notebookId");
    e.tree.addNodes(e.tree.getNodeByTId(t), {Title: "", NotebookId: getObjectId(), IsNew: !0}, !1, !0)
}, Notebook.deleteNotebook = function (o) {
    var e = Notebook, t = $(o).attr("notebookId");
    t && ajaxGet("/notebook/deleteNotebook", {notebookId: t}, function (o) {
    ...
    function o(o) {
        var e = $(this).attr("notebookId"), t = Notebook.cache[e];
        if (t) {
            var N = [];
            t.IsBlog ? N.push("set2Blog") : N.push("unset2Blog"), Note.notebookHasNotes(e) && N.push("delete"), o.applyrule({
                name: "target2",
                disable: !0,
                items: N
            })
...
function addShareNoteOrNotebook(e) {
    var t = "#tr" + e, o = Share.dialogNoteOrNotebookId,
        r = isEmailFromInput(t + " #friendsEmail", "#shareMsg", getMsg("inputFriendEmail"));
    if (r) {
        var a = $(t + ' input[name="perm' + e + '"]:checked').val() || 0, n = a, s = "/share/addShareNote",
        ...
        Share.dialogIsNote || (s = "/share/addShareNotebook", i = {
            ...
            if (e) if (e.Ok) {
                var a = tt("<td>?</td>", "#");
                a += tt("<td>?</td>", r), a += tt('<td><a href="#" noteOrNotebookId="?" perm="?" toUserId="?" title="' + getMsg("clickToChangePermission") + '" class="btn btn-default change-perm">?</a></td>', o, n, e.Id, n && "0" != n ? getMsg("writable") : getMsg("readOnly")), a += tt('<td><a href="#" noteOrNotebookId="?" toUserId="?" class="btn btn-warning delete-share">' + getMsg("delete") + "</a></td>", o, e.Id), $(t).html(a)
            } else {
...
Share.defaultNotebookId = "share0", Share.defaultNotebookTitle = getMsg("defaultShare"), Share.sharedUserInfos = {}, Share.userNavs = {}, Share.notebookCache = {}, Share.cache = {}, Share.dialogIsNote = !0, Share.setCache = function (e) {
    ...
    if (!isEmpty(e)) {
        ...
        for (var s in e) {
            ...
            n.append(c + u + "</li>"), a.trees[l] = $.fn.zTree.init($("#" + N), Notebook.getTreeSetting(!0, !0), userNotebooks), a.userNavs[l] = {forNew: a.getNotebooksForNew(l, d)}, log(a.userNavs)
        }
        ...
        }, b = $("#shareNotebooks").contextmenu(f), k = {
            width: 180,
            items: [{
    ...
    if (o) {
        ...
        var r = "", a = "";
        if (Share.notebookCache[t].Perm) r = t, a = Share.notebookCache[t].Title; else {
    ...
    var n = "/share/listShareNotes", s = {userId: e};
    ...
    if (confirm("Are you sure to delete it?")) {
        var t = $(e).attr("notebookId"), o = $(e).closest(".friend-notebooks").attr("fromUserId");
        ajaxGet("/share/DeleteShareNotebookBySharedUser", {notebookId: t, fromUserId: o}, function (t) {
            t && $(e).parent().remove()
        })
    }
}, Share.deleteShareNote = function (e) {
    var t = $(e).attr("noteId"), o = $(e).attr("fromUserId");
    ajaxGet("/share/DeleteShareNoteBySharedUser", {noteId: t, fromUserId: o}, function (t) {
        t && $(e).remove()
    })
    ...
    if (confirm("Are you sure to delete all shared notebooks and notes?")) {
        ...
        ajaxGet("/share/deleteUserShareNoteAndNotebook", {fromUserId: t}, function (t) {
            t && $(e).parent().remove()
        })
    }
    ...
    var o = "/share/listShareNotes", r = {userId: t, notebookId: e};
    ...
    function t(e) {
        var t = $(this).attr("noteId"), o = Note.getNote(t), r = [];
    ...
    $("#noteItemList").on("click", ".item-shared .item-setting", function (e) {
        ...
        var e = $(this).parent().attr("notebookId"), t = $(this).parent().attr("userId");
        "M" == $(this).text() ? Note.newNote(e, !0, t, !0) : Note.newNote(e, !0, t)
    }), $("#leanoteDialogRemote").on("click", ".change-perm", function () {
        var e = this, t = $(this).attr("perm"), o = $(this).attr("noteOrNotebookId"), r = $(this).attr("toUserId"),
            a = getMsg("writable"), n = "1";
        "1" == t && (a = getMsg("readOnly"), n = "0");
        var s = "/share/updateShareNotebookPerm", i = {perm: n, toUserId: r};
        ...
        var e = this, t = $(this).attr("noteOrNotebookId"), o = $(this).attr("toUserId"),
            r = "/share/deleteShareNotebook", a = {toUserId: o};
    ...
    $("#leanoteDialogRemote").on("click", "#addShareNotebookBtn", function () {
        ...
        var e = $("#emailContent").val(), t = $("#toEmail").val();
        return e ? void post("/user/sendRegisterEmail", {content: e, toEmail: t}, function (e) {
